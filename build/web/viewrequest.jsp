	  ...
	  <div id="content">
        <div class="content_item">
            ...
            <p><br><br> </p><br><br>
                                ...
                                <font size="4" color="white">   <center>List Of User Requested Files </center></font>
		  ...
		  <br style="clear:both"/>
            ...
            <table border=1; width=700px; cellpadding=2; cellspacing=2;>
               <font color="blue"> 
                   ...
                   <%
                    String query="select* from keyrequest";
              ...
              while(rs.next()){
                  %>
                   ...
                   <th style="background-color:whitesmoke"><%=rs.getString("filename")%></th>
                    ...
                    %>
                    <th style="background-color:activecaption"><font colour="red"><a href="generatekey.jsp?filename=<%=rs.getString("filename")%>"><%=rs.getString("keygen")%></a></font></th>
                    <%
                    }else{
                    %>
