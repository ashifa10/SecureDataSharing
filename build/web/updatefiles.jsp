	  ...
	  <div id="content">
        <div class="content_item">
            ...
            <p><br><br> </p><br><br>
             ...
             <font size="4" color="white">   Update Your Files	  
		  ...
		  <br style="clear:both"/>
            ...
            <table border=1; width=700px; cellpadding=2; cellspacing=2;>
               <font color="blue"> 
                   <tr>
                   <th style="background-color:background">File ID</th>
                    <th style="background-color:background">File Name</th>
                      <th style="background-color:background">Upload Date</th>
                    </font>
                   </tr>  
                   <%
                    String query="select* from uploadfiles where ownername='"+session.getAttribute("provnames")+"'";
              ...
              while(rs.next()){
                  %>
                    <tr>
                   <th style="background-color:whitesmoke"><%=rs.getString("id")%></th>
                   <th style="background-color:activecaption"><font colour="red"><a href="update.jsp?filename=<%=rs.getString("filename")%>"><%=rs.getString("filename")%></a></font></th>
