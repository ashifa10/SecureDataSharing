	  ...
	  <div id="content">
        <div class="content_item">
            ...
            <p><br><br> </p><br><br>
             ...
             <font size="4" color="white">    Revoked Users	  </font>
            <div class="form_settings">
            <table border=1; width=700px; cellpadding=2; cellspacing=2;>
               <font color="blue"> 
                   <tr>
                   <th style="background-color:background">User Name</th>
                    <th style="background-color:background">Email</th>
                      <th style="background-color:background">Status</th>
                    </font>
                   </tr>   
                   <%
                    String query="select* from datauser where status='revoked'";
              ...
              while(rs.next()){
                  %>
                   ...
                   <th style="background-color:whitesmoke"><%=rs.getString("name")%></th>
                    <th style="background-color:whitesmoke"><%=rs.getString("email")%></th>
                   
                    <th style="background-color:activecaption"><font colour="red"><a href="unrevokecheck.jsp?name=<%=rs.getString("name")%>">UNREVOKE USER</a></font></th>
